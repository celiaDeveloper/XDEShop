...
#define ForegroundStarImage @"HPStarRateViewstaryellow"
#define BackgroundStarImage @"HPStarRateViewstargray"

typedef void(^completeBlock)(CGFloat currentScore);

@interface HPStarRateView()

@property (nonatomic, strong) UIView *foregroundStarView;//黄色星星View

@property (nonatomic, strong) UIView *backgroundStarView;//灰色星星View

@property (nonatomic, assign) NSInteger numberOfStars; //不同星星的个数
...
- (void)layoutSubviews {
    ...
    __weak HPStarRateView *weakSelf = self;
