//
//  UIButton+HPImageTitleSpacing.m
//  HP_iOS_CommonFrame
//
...
@implementation UIButton (HPImageTitleSpacing)
...
- (void)layoutButtonWithEdgeInsetsStyle:(HPButtonEdgeInsetsStyle)style imageTitleSpace:(CGFloat)space {
    ...
    switch (style) {
        case HPButtonEdgeInsetsStyleTop:
        {
            imageEdgeInsets = UIEdgeInsetsMake(-labelHeight-space/2.0, 0, 0, -labelWidth);
            labelEdgeInsets = UIEdgeInsetsMake(0, -imageWith, -imageHeight-space/2.0, 0);
        }
            break;
        case HPButtonEdgeInsetsStyleLeft:
        {
            imageEdgeInsets = UIEdgeInsetsMake(0, -space/2.0, 0, space/2.0);
            labelEdgeInsets = UIEdgeInsetsMake(0, space/2.0, 0, -space/2.0);
        }
            break;
        case HPButtonEdgeInsetsStyleBottom:
        {
            imageEdgeInsets = UIEdgeInsetsMake(0, 0, -labelHeight-space/2.0, -labelWidth);
            labelEdgeInsets = UIEdgeInsetsMake(-imageHeight-space/2.0, -imageWith, 0, 0);
        }
            break;
        case HPButtonEdgeInsetsStyleRight:
        {
