...
- (void)setBeSelected:(BOOL)beSelected {
    ...
    if (beSelected) {
        self.titleLabel.backgroundColor = [MSSAutoresizeLabelFlowConfig shareConfig].itemSelectedColor;
        self.titleLabel.textColor = [MSSAutoresizeLabelFlowConfig shareConfig].textSelectedColor;
    }else {
       self.titleLabel.backgroundColor = [MSSAutoresizeLabelFlowConfig shareConfig].itemColor;
        self.titleLabel.textColor = [MSSAutoresizeLabelFlowConfig shareConfig].textColor;
    }
}
