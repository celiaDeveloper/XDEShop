...
- (void)setIncreaseBackColor:(UIColor *)increaseBackColor {
    _increaseBackColor = increaseBackColor;
    [_increaseBtn setBackgroundColor:increaseBackColor];
}

- (void)setDecreaseBackColor:(UIColor *)decreaseBackColor {
    _decreaseBackColor = decreaseBackColor;
    [_decreaseBtn setBackgroundColor:decreaseBackColor];
}
